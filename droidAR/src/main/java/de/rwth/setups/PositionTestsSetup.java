...
public class PositionTestsSetup extends Setup {
	...
	public PositionTestsSetup() {
		...
		posA = new GeoObj(65.01738929999999, 25.468082600000002);
		posB = new GeoObj(65.01331597386593, 25.464677810668945);
		posC = new GeoObj(65.0047943, 25.40155630000004);
		posD = new GeoObj(63.0047943, 22.40155630000004);
		posE = new GeoObj(65.00916, 25.502771);
